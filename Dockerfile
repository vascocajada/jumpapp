...
# Install Chromium and ChromiumDriver from apt, and symlink for Panther compatibility
RUN apt-get update \
    && apt-get install -y wget unzip gnupg ca-certificates fonts-liberation chromium chromium-driver \
